...
$("#fav").click(function () {
    ...
    $.ajax(
        {
            type: 'get',
            url: '/hotels/favourite/' + id,
            contentType: 'application/json',
            data: id,
            success: function (response) {
                if (response.success) {
                    toastr.success(response.msg);
                    if ($("#fav span").hasClass('fa-star')) {
                        $("#fav span").removeClass('fa-star')
                        $("#fav span").addClass('fa-star-o')

                    }
                    else {
                        $("#fav span").removeClass('fa-star-o')
                        $("#fav span").addClass('fa-star')
                    }
                }
                else {
